...
export const OrderApi = {
  ...
  delete: async order_id =>
    await http.delete(`hotels/meals/orders/${order_id}`, {}, true)
};

export const RoomApi = {
  get: async hotel_id => await http.get(`hotels/rooms/${hotel_id}`),
  getAll: async () => await http.get("hotels/rooms/all", true),
  getAllAvailable: async () => await http.get("hotels/rooms/available", true),
  checkout: async roomNum =>
    await http.delete(`hotels/rooms/checkout/${roomNum}`, {}, true),
  checkin: async (number, user_id, guest_amount, start_date, end_date) =>
    await http.post(
      `hotels/rooms/checkin`,
      {
        number,
        user_id,
        guest_amount,
